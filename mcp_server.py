...
from db import add_sale, catalog, dashboard, init_db, database_schema, sales_periods, sales_histogram
...
def call_tool(name,args):
 ...
 if name=="consultar_semantica": return text_result(query_semantic(args.get("dimensiones"),args.get("metrica"),{k:v for k,v in args.items() if k in ("desde","hasta","region","provincia","canal")},args.get("limite",12)))
